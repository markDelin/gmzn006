...
def tekan_ya():
    messagebox.showinfo("Reymark", "So ano pwede nga?")
    buka_whatsapp()
...
def buka_whatsapp():
    ...
    webbrowser.open_new(f"https://www.facebook.com/gmzn006")

window = tk.Tk()
window.title("Parang tanga lang")
...
label = tk.Label(frame, text="I have crush on you,\npwede ba kitang ligawan?", font=("Helvetica", 16, "bold"), bg='#FFC0CB', fg='#FF69B4', justify=tk.CENTER)
label.pack(pady=20)
